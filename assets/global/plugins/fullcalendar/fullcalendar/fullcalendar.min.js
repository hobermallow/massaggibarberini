 ...
 * (c) 2013 Adam Shaw
 */
// inverte un formato (mese/giorno) in (giorno/mese) es. 7/22 -> 22/7
function inverti_mese_giorno(stringa) {


    var giorno_settimana = "";

    var c = 0;
    while (stringa.charAt(c) != ' ') {
        giorno_settimana = giorno_settimana + stringa.charAt(c);

        c++;
    }

    stringa = stringa.slice(c);
    ...
    //ciclo per il mese
    var i = 0;
    while (stringa.charAt(i) != '/' && i < stringa.length) {
        mese = mese + stringa.charAt(i);
    ...
    i++;
    while (stringa.charAt(i) != '/' && i < stringa.length) {
        giorno = giorno + stringa.charAt(i);

        i++;
    }

    return (giorno_settimana + " " + giorno + "/" + mese);

}//function inverti_mese_giorno(stringa)

//a partire dal link di edit della visita ritorna il link per la rimozione della visita
function get_link_edit_visita(stringa) {
	
	//ottengo l'id della visita a partire da una stringa completa (stringa di edit della singola visita)
	var i = 0;
	var stringa_numerica_id = "";
	while( i < stringa.length )
	{
		...
		{
			//il carattere in questione è un numero quindi lo salvo nella stringa risultante
			stringa_numerica_id = stringa_numerica_id + stringa[i];
		}
		
		i++;
	}

    var link_edit_visita = base_url+"deletevisita/delete/" + stringa_numerica_id;

    return link_edit_visita;

}//function get_link_edit_visita(stringa)

function redirect_steph(url) {
    window.location = url;
}
...
(function(t, e) {
    ...
    function Z(e, n, r) {
        ...
        function h(t) {
            ...
            return t.getMonth() != n && o.push("fc-other-month"), +t == +r ? o.push("fc-today", le + "-state-highlight") : r > t ? o.push("fc-past") : o.push("fc-future"), a += "<td class='" + o.join(" ") + "'" + " data-date='" + xe(t, "yyyy-MM-dd") + "'" + ">" + "<div>" + "<span class=\"badge badge-success\" style=\"cursor: pointer;\" onclick=\"add_visita(" + id_dottore + "," + t.getDate() + "," + (t.getMonth() + 1) + "," + t.getFullYear() + ")\" \" >+</span>", re && (a += "<a style=\"color: black;\" target=\"_blank\" href=\""+base_url+"daycalendar/view/" + id_dottore + "/" + t.getDate() + "/" + (t.getMonth() + 1) + "/" + t.getFullYear() + "\" ><div class='fc-day-number'>" + t.getDate() + "</div></a>"), a += "<div class='fc-day-content'><div style='position:relative'>&nbsp;</div></div></div></td>"
        }
    ...
    function K(n, r, a) {
        ...
        function g() {
            var t, e, n, r = qe + "-widget-header",
                a = "";
            for (a += "<thead><tr>", Xe ? (t = nn(0, 0), e = on(t, Ve), Ye ? e += Je : e = Je + e, a += "<th class='fc-agenda-axis fc-week-number " + r + "'>" + q(e) + "</th>") : a += "<th class='fc-agenda-axis " + r + "'>&nbsp;</th>", n = 0; We > n; n++) t = nn(0, n), a += "<th class='fc-" + ke[t.getDay()] + " fc-col" + n + " " + r + "'>" + inverti_mese_giorno(q(on(t, Ie))) + "</th>";
    ...
    function de() {
        ...
        function c(t) {
            ...
            var i = j(r, T);
            return e += a ? "<a " : "<div", e += " class='" + o.join(" ") + "'" + " style=" + "'" + "position:absolute;" + "left:" + t.left + "px;" + i + "'" + ">" + "<div class='fc-event-inner' /*steph:*/ title=\"vedi dettagli visita\" ><span class=\"badge badge-warning\" style=\"float: right; cursor: pointer; z-index: 98;\" onclick=\"redirect_steph('" + get_link_edit_visita(q(a)) + "')\" >X</span>", !r.allDay && t.isStart && (e += "<span class='fc-event-time'>" + q(G(r.start, r.end, "H:mm")) + "</span>"), e += "<span class='fc-event-title' onclick=\"redirect_steph('" + q(a) + "')\" >" + q(r.title || "") + "</span>" + "</div>", t.isEnd && F(r) && (e += "<div class='ui-resizable-handle ui-resizable-" + (n ? "w" : "e") + "'>" + "&nbsp;&nbsp;&nbsp;" + "</div>"), e += "</" + (a ? "a" : "div") + ">"
        }
