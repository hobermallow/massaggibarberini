        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <form action="<?php echo base_url(); ?>gestionedottori/edit/<?php echo $dottore_edit[0]->id; ?>" method="post" >
                        <div class="row" >
                            <div class="col-lg-6">
                                <div class="input-icon margin-top-10">
                                    <label>Nome:</label>
                                    <i class="fa fa-user"></i>
                                    <input type="text" class="form-control" name="nome" value="<?php echo $dottore_edit[0]->nome; ?>" >
                                </div>
                                <div class="input-icon margin-top-10">
                                    <label>Telefono:</label>
                                    <i class="fa fa-user"></i>
                                    <input type="text" class="form-control" name="telefono" value="<?php echo $dottore_edit[0]->telefono; ?>" >
                                </div>
                                <div class="input-icon margin-top-10">
                                    <label>Email:</label>
                                    <i class="fa fa-user"></i>
                                    <input type="text" class="form-control" name="email" value="<?php echo $dottore_edit[0]->email; ?>" >
                                </div>
                            </div>
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-heart"></i>Tabella Orari
                            </div>
                        </div>
                        <div class="portlet-body flip-scroll">
                            <table class="table table-bordered table-striped table-condensed flip-content">
                                ...
                                <tbody>
                                    <?php
                                    $array_giorni = ['Domenica', 'Lunedi', 'Martedi', 'Mercoledi', 'Giovedi', 'Venerdi', 'Sabato'];
                                    foreach ($orari as $orario):
                                        ?>
                                        <?php if ($orario != NULL): ?>
                                        <tr>
                                            <td>
                                                <?php echo $array_giorni[$orario->giorno]; ?>
                                            </td>
                                            <td>
                                                <?php echo $orario->orario_inizio; ?>
                                            </td>
                                            <td>
                                                <?php echo $orario->orario_fine; ?>
                                            </td>
                                        </tr>
                                        <?php endif; ?>
                                        <?php
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body flip-scroll">
                            <table class="table table-bordered table-striped table-condensed flip-content">
                                ...
                                <tbody>
                    <?php //foreach ($prestazioni->result() as $row): ?>
                                        <tr>
                                            <td>
                    ...
                    <?php //echo $row->costo_prestazione; ?>&euro;
                                            ...
                                            <td class="numeric" style="text-align: center;" >
                                                <a href="<?php //echo base_url();     ?><?php //echo "gestionedottori/editprestazione/" . $row->id;     ?>" title="Modifica" class="btn red">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a href="<?php //echo base_url();     ?><?php //echo "gestionedottori/deleteprestazione/" . $row->id;     ?>" onclick="return confirm('Sei sicuro di voler eliminare questa prestazione?')" title="Elimina" class="btn purple">
                                                    <i class="fa fa-times"></i>
                                                </a>
                                            </td>
                                        </tr>
                    ...
                    <h2 class="page-title">Fatture</h2>
