...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h2 class="page-title" >Modifica della prestazione specialistica</h2>
            ...
            <?php $prestazione_edit = $prestazione_edit->result(); ?>
            
            <form action="<?php echo base_url(); ?>prestazionispecialistiche/edit/<?php echo $prestazione_edit[0]->id_prestazione; ?>" method="post" >
            ...
            <div class="col-lg-6">
                ...
                <h2 class="page-title" style="font-size: 16px;" >Nome:</h2>
                    ...
                    <input type="text" class="form-control" name="nome_prestazione" value="<?php echo $prestazione_edit[0]->nome_prestazione; ?>" >
                </div>
