...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
            ...
            <div class="col-lg-12">
            	<h2 class="page-title" style="font-size: 24px;" >Dottore: <?php echo $visita_corrente[0]->nome; ?></h2>
            </div>
            ...
            <div class="col-lg-12">
            	<div class="portlet box green">
						...
						<div class="portlet-body">
							<?php echo nl2br( $visita_corrente[0]->descrizione ); ?>
						</div>
					</div>
            </div>
            ...
            <div class="col-lg-12">
            	<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-heart"></i>Dettaglio visita
							</div>
							
						</div>
						<div class="portlet-body">
							<?php echo nl2br( $visita_corrente[0]->dettaglio ); ?>
						</div>
					</div>
            </div>
