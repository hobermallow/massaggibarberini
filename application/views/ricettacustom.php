...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h2 class="page-title" >Creazione nuova ricetta personalizzata</h2>
            ...
            <div class="row" style="text-align: center;" >
				<div class="form-group">
                    <h2 style="color: #4B8DF8; font-weight: bold;" >Ricetta Personalizzata:</h2>
                </div>
            </div>
            ...
            <div class="row" >
            	...
            	<div class="col-lg-6" >
                    ...
                    <label>Nome:</label>
                        ...
                        <input type="text" class="form-control" name="ricetta_campo_nome" required />
                    </div>
                    
                    <div class="input-icon margin-top-10">
                    <label>Cognome:</label>
                        <i class="fa fa-user"></i>
                        <input type="text" class="form-control" name="ricetta_campo_cognome" required />
                    </div>
                ...
                <div class="col-lg-6" >
                    ...
                    <label>Indirizzo:</label>
                        <i class="fa fa-user"></i>
                        <input type="text" class="form-control" name="ricetta_campo_indirizzo" required />
                    </div>
                    
                    <div class="input-icon margin-top-10">
                    <label>Codice Fiscale:</label>
                        <i class="fa fa-user"></i>
                        <input type="text" class="form-control" name="ricetta_campo_codice_fiscale" required />
                    </div>
            ...
            <div id="container_form" class="row" >
                ...
                <div class="col-lg-6" >
                    ...
                    <div id="box_standard" >
                        <label>Campo personalizzato (non-gestanti):</label>
                        <div class="input-icon margin-top-10">
