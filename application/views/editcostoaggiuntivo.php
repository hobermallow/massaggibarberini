        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                        ...
                        <div class="row" >
                            <div class="input-icon margin-top-10">
                                <div class="note note-danger">
                                    ...
                                    <p>
                                        Errore durante l'aggiornamento del costo aggiuntivo
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                    <form method="post" action="<?php echo base_url();?>costi_aggiuntivi/edit/<?php echo $costo_aggiuntivo->id;?>"  >
                                    		
                                    		<label>Descrizione: <input type="text" class="form-control" value="<?php echo $costo_aggiuntivo->descrizione; ?>" name="descrizione"></label>
											<br>
											<label>Costo: <input class="form-control" type="text" value="<?php echo $costo_aggiuntivo->costo;?>" name="costo" >
											</label>
											<br>
											<input type="submit" value="Modifica" class="btn btn-default">
									<a class="btn btn-danger" href="<?php echo base_url();?>costi_aggiuntivi" >Annulla</a>
									</form>
