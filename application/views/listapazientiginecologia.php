...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
            ...
            <form action="<?php echo base_url(); ?>listapazienti/searchginecologia" method="post" >
            <div class="row" >
            	<div class="col-md-4" >
...
<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-users"></i>Tabella Pazienti (Ginecologia)
							</div>
						...
						<div class="portlet-body flip-scroll">
							...
							<tr>
                                ...
                                <td class="numeric" style="text-align: center;" >
									<a href="<?php echo "/listapazienti/edit/" . $row->id; ?>" title="Modifica" class="btn red">
										<i class="fa fa-edit"></i>
									</a>
                                    <a href="<?php echo "/listapazienti/delete/" . $row->id; ?>" title="Elimina" class="btn purple">
...
<div class="row">
   ...
   <div class="pagination-panel"> Pagina
   		...
   		<a href="<?php echo "/listapazienti/viewginecologia/" . ($pagina_attuale-1); ?>" class="btn btn-sm default prev <?php if( $pagina_attuale == 1 ) echo "disabled"; ?>" title="Prev"><i class="fa fa-angle-left"></i></a>
   		<span><?php echo $pagina_attuale; ?></span>
   		<a href="<?php echo "/listapazienti/viewginecologia/" . ($pagina_attuale+1); ?>" class="btn btn-sm default next <?php if( $pagina_attuale == $pagine_totali ) echo "disabled"; ?>" title="Next"><i class="fa fa-angle-right"></i></a> di <span class="pagination-panel-total"><?php echo $pagine_totali; ?></span></div></div>

        
   </div>
   
   <div class="col-md-3 col-sm-12" >
   	<form action="<?php echo base_url(); ?>listapazienti/viewginecologia" method="post" >
