...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h2 class="page-title" >Il tuo Drive</h2>
            ...
            <div class="col-md-12" >
            	...
            	<h2 style="color: #4B8DF8; font-weight: bold;" >Carica un file sul tuo spazio riservato Google Drive:</h2>
        ...
        <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-heart"></i>Il tuo Drive
                        </div>
                    ...
                    <div class="portlet-body flip-scroll">
                        ...
                        <tr>
                            ...
                            <td class="numeric" style="text-align: center;" >
                                ...
                                <a href="<?php echo base_url(); ?>userdrive/delete/<?php echo $file->id; ?>" title="Elimina il file" class="btn purple" >
