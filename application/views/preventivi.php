            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <form id="form-preventivo" method="post" >
                        <div class="row" >
                            <div class="col-sm-12">
                                <h2 class="page-title" style="font-size:16px;">Dottore</h2>
                            </div>
                            <div class="col-sm-4">
                                <div class="input-icon">
                                    <i class="fa fa-user"></i>
                                    <select name="dottore" id="dottore" class="form-control">
                                        <?php
                                        foreach ($dottori->result() as $dott) {
                                            echo "<option data-id='" . $dott->id . "' value=" . $dott->paga_oraria . ">" . $dott->nome . "</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
                    ...
                    <form id="aggiungi">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <button type="submit" id="add-button" class="btn blue">Aggiungi</button>
                            </div>
                        </div>
                    </form>
                    <div class="row">
                    ...
                    <div class="row" >
                        <div class="col-sm-12">
                            <h2 class="page-title" style="margin:15px 0;font-size:16px;">Paziente</h2>
                        </div>
                        <div class="col-sm-4">
                            <div class="input-icon">
                                <i class="fa fa-user"></i>
                                <select name="paziente" id="paziente" class="form-control">
                                    ...
                                    foreach ($pazienti as $paziente) {
                                        echo "<option value=" . $paziente->id . ">" . $paziente->nome . "</option>";
                                    }
                                    ?>
                                </select>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div>
                                <textarea rows="4" style="resize: none;" name="descrizioneVisita" id="descrizioneVisita" class="form-control" placeholder="Descrizione Visita"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="input-icon">
                        ...
                        <div class="row">
                            <div class="col-sm-4 margin-top-20">
                                <div class="input-icon">
                                    ...
                                    <input type="text" class="form-control" form="accetta-preventivo" required id="totale" placeholder="totale"/>
                                </div>
                            </div>
            ...
            $(document).ready(function () {
                ...
                $("#accetta-preventivo").submit(function (e) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'JSON',
                        data: {dottore: $('#dottore').find(":selected").data('id'), totale: $("#totale").val(), paziente: $("#paziente").val(), prodotti: addedProducts,
                            ore: $("#ore").val(), descrizione: $("#descrizioneVisita").val(), data_visita: $("#data_visita").val(), ora_visita: $("#ora_visita").val()
                        }
                    })
                            .then(function (data) {
                                console.log(data);
                ...
                $("#form-preventivo").submit(function (e) {
                    e.preventDefault();
                    if ($("#ore").val().trim() === "") {
                        alert("Il campo ore è obbligatorio");
                        return;
                    }
                    var totale = 0;
                    for (var i = 0; i < addedProducts.length; i++) {
                        totale += addedProducts[i].prezzo * addedProducts[i].quantita;
                    }
                    var totaleDottore = parseFloat($("#dottore").val()) * parseFloat($("#ore").val());
                    totale += totaleDottore;
                    $("#totale").val(totale);
                });
                var addedProducts = [];
                $("#aggiungi").submit(function (e) {
                    ...
                    addedProducts.push({id: prodotto.data("id"), quantita: parseInt($("#quantita").val()), prezzo: parseFloat($('#prodotto').val())});

                    var htmlRow = "<div class='row detail-row' data-id=" + prodotto.data("id") + " style='border-bottom:1px solid #000;'>" +
                            "<div class='col-sm-3'>" + prodotto.text() + "</div>" +
                            "<div class='col-sm-3'>Quantità: " + $("#quantita").val() + "</div>" +
                    ...
                    $("#prodotti-selezionati").append(htmlRow);
