        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <form action="<?php echo base_url(); ?>comparazionecalendari" method="post" >

                        <div class="col-lg-6" style="float: right; text-align: right;" >
                            <span style="font-size: 18px; font-weight: bold; color: #4B8DF8;" >Comparazione calendario:</span>
                            <select name="compare_with" class="form-control">
                                <?php foreach ($dottori->result() as $doctor): ?>
                                    <option value="<?php echo $doctor->id; ?>" ><?php echo $doctor->nome; ?></option>
                                <?php endforeach; ?>
                            </select>
                            <input type="hidden" name="dottore_iniziale" value="<?php echo $dottore_curr[0]->id; ?>" />
                            <button style="margin-top: 8px;" type="submit" name="submit" value="submit" class="btn green">Compara calendari</button>
                        </div>
